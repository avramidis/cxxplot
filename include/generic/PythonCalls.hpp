...
namespace cxxplot {
    ...
    public:
        ...
        static void pyobject_call_with_checks(PyObject *object_to_call, PyObject *args, PyObject *kwargs);

        static void pyobject_callobject_with_checks(PyObject *object_to_call);

        static void pyobject_callobject_with_checks(PyObject *object_to_call, PyObject *args);
    };
}
