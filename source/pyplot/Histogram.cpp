...
namespace cxxplot {
    ...
    template <class inputType> Histogram<inputType>::Histogram() {
        this->figure();
        initialize();
    }
    ...
    template <class inputType> void Histogram<inputType>::initialize() {
        histogram = PythonCalls::get_pyobject_function_by_string(
            this->matplotlib_pyplot, "hist");
    }

    template <class inputType>
    void Histogram<inputType>::draw(std::vector<inputType> &x, int bins) {
    ...
    void Histogram<inputType>::draw(
        ...
        PythonCalls::pyobject_call_with_checks(histogram, histogram_args,
                                               kwargs);
    }
