...
namespace cxxplot {
    ...
    Axis::Axis(Axis_option option) {
        ...
        PyTuple_SetItem(args, 0,
                        Py_BuildValue("s", get_option_string_value(option)));
    ...
    const char *Axis::get_option_string_value(Axis_option option) {
        switch (option) {
        case Axis_option::on:
            return "on";
        case Axis_option::off:
            return "off";
        case Axis_option::equal:
            return "equal";
        case Axis_option::scaled:
            return "scaled";
        case Axis_option::tight:
            return "tight";
        case Axis_option::automatic:
            return "automatic";
        case Axis_option::normal:
            return "normal";
        case Axis_option::image:
            return "image";
        case Axis_option::square:
            return "square";
        default:
            return "";
        }
    ...
    void Axis::initialize() {
        axis = PythonCalls::get_pyobject_function_by_string(
            this->matplotlib_pyplot, "axis");
    }
} // namespace cxxplot
